...
layout: true
background-image: url(skclogo.png)
...
<p>'Course of Study' is still under preparation... </p>
</div>
...
**Course title**: Master in Buddhist Studies and Sustainable Development (<span style="color: blue;">MBSD</span>).
